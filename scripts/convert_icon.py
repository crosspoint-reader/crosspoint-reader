...
"""Convert an image (PNG, JPG, SVG) to a C header file containing a 1-bit-per-pixel
e-ink icon bitmap. Resizes to the given dimensions, rotates 90 degrees counter-clockwise,
threshold-converts to black/white, and writes a static const uint8_t[] array to
src/components/icons/<name>.h."""

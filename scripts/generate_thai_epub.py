...
<p><b>Tone + Sara Am (decomposition test):</b><br/>
น้ำ (Mai Tho + Sara Am) — Nikhahit should stack above tone mark<br/>
ค่ำ ท่ำ จ่ำ ร่ำ (Mai Ek + Sara Am)<br/>
น๊ำ น๋ำ (Mai Tri/Chattawa + Sara Am)<br/>
กำ ขำ คำ (Sara Am alone — no decomposition needed)</p>

...
def load_translations(
    ...
    # This assigns the Language enum ordinal; it has no effect on the visible
    # Settings menu order (see SORTED_LANGUAGE_INDICES, sorted by _language_name)
    # or on stored user preferences, since settings.json persists the

...
// v47: Images honour their containing block's horizontal alignment and insets instead of
//      always centring on the full viewport; cached pages hold the old centred x positions.

...
class KOReaderCredentialStore {
 private:
  ...
  bool allowUntrustedCert = false;                                  // Skip TLS cert validation (self-signed servers)
 ...
 public:
  ...
  // Accept self-signed / untrusted server certificates (skips TLS validation)
  void setAllowUntrustedCert(bool allow);
  bool getAllowUntrustedCert() const { return allowUntrustedCert; }
};

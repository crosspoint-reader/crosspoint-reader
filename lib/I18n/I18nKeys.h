...
// Alphabetically sorted language indices (auto-generated by gen_i18n.py)
// Order: English, Català, Deutsch, Español, Français, Português (Brasil), Română, Svenska, Čeština, Русский
constexpr uint8_t SORTED_LANGUAGE_INDICES[] = {0, 9, 3, 1, 2, 5, 8, 7, 4, 6};

...
// Order: English, Català, Čeština, Deutsch, Español, Français, Português (Brasil), Română, Svenska, Русский
constexpr uint8_t SORTED_LANGUAGE_INDICES[] = {0, 9, 4, 3, 1, 2, 5, 8, 7, 6};

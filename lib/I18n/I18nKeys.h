...
enum class StrId : uint16_t {
  ...
  STR_WALLABAG,
  STR_WALLABAG_BROWSER,
  STR_WALLABAG_DOWNLOAD,
  STR_WALLABAG_GO_TO_FOLDER,
  STR_WALLABAG_SERVER_URL,
  STR_WALLABAG_CLIENT_ID,
  STR_WALLABAG_CLIENT_SECRET,
  STR_WALLABAG_USERNAME,
  STR_WALLABAG_PASSWORD,
  STR_WALLABAG_ARTICLE_LIMIT,
  STR_WALLABAG_SYNCING,
  STR_WALLABAG_AUTH_FAILED,
  STR_WALLABAG_SYNC_COMPLETE,
  STR_WALLABAG_NO_ARTICLES,
  STR_WALLABAG_ARTICLES_DOWNLOADED,
  STR_WALLABAG_DOWNLOADING,
  STR_WALLABAG_UNLIMITED,

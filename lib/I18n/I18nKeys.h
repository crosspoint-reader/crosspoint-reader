...
// Order: English, Беларуская, Català, Čeština, Dansk, Español, Suomi, Français, Deutsch, Italiano, Nederlands, Polski,
// Português (Brasil), Română, Русский, Svenska, Українська
constexpr uint8_t SORTED_LANGUAGE_INDICES[] = {
    ...
    static_cast<uint8_t>(Language::DA),         static_cast<uint8_t>(Language::ES),
    static_cast<uint8_t>(Language::FI),         static_cast<uint8_t>(Language::FRENCH),
    static_cast<uint8_t>(Language::GERMAN),     static_cast<uint8_t>(Language::IT),
    ...
    static_cast<uint8_t>(Language::RUSSIAN),    static_cast<uint8_t>(Language::SWEDISH),

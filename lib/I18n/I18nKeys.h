...
enum class StrId : uint16_t {
  ...
  STR_EMBEDDED_STYLE,
  STR_OPDS_SERVER_URL,
  STR_KOREADER_PAGE_TURNER,
  STR_KPT_INSTRUCTION_1,
  STR_KPT_INSTRUCTION_2,
  STR_KPT_INSTRUCTION_3,
  STR_KPT_INSTRUCTION_4,
  STR_KPT_INSTRUCTION_5,
  STR_KPT_INSTRUCTION_6,
  STR_KPT_ADDRESS,
  STR_KPT_SET_ADDRESS_FIRST,
  STR_KPT_ENTER_ADDRESS,
  STR_KPT_CONNECTED_TO,
  STR_KPT_PAGE_TURN_HINT,
  STR_KPT_ERROR_FWD,
  STR_KPT_ERROR_BACK,
  STR_KPT_CHANGE_IP,

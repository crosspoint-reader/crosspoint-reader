...
const char* const CHARACTER_SETS[] = {
    ...
    "\x91"
    "",  // Português (Brasil)
    " !%()*+,-./012345:=?ABCDEFHIJKLMNOPQRSTUWX[]abcdefhiklmnoprstuxyz|\xC2"
    "\xAB"
    "\xC2"
    "\xBB"
    "\xD0"
...
const char* const STRINGS_ES[] = {
    ...
    "n de la pantalla",
    "Contraste",
    "Completa con porcentaje",
    "Completa con progreso del libro",
    "Solo progreso del libro",
    "Completa con progreso de cap\xC3"
    "\xAD"
    "tulos",
    "Estilo de pantalla",
    "Cl\xC3"

...
You can select a sequence of words to look up as a phrase. This is also useful for languages that don't use spaces between words like Chinese, Japanese, or languages where spaces separate syllables instead of words like Vietnamese.

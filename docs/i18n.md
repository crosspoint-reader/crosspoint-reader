...
Packs are built by the `language-packs` job in
`.github/workflows/release.yml`, which reads the built-in set straight out of
`platformio.ini` and attaches `language-packs.zip` to the release. Locally:

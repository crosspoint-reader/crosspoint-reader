...
void XtcReaderActivity::renderScreen() {
  ...
  if (currentPage >= xtc->getPageCount()) {
    ...
    renderer.drawCenteredText(UI_12_FONT_ID, 300, "End of book", true, CrossPointFont::BOLD);
...
void XtcReaderActivity::renderPage() {
  ...
  if (!pageBuffer) {
    ...
    renderer.clearScreen();
    renderer.drawCenteredText(UI_12_FONT_ID, 300, "Memory error", true, CrossPointFont::BOLD);
    renderer.displayBuffer();
    return;
  }
  ...
  if (bytesRead == 0) {
    ...
    free(pageBuffer);
    renderer.clearScreen();
    renderer.drawCenteredText(UI_12_FONT_ID, 300, "Page load error", true, CrossPointFont::BOLD);
    renderer.displayBuffer();
    return;
  }

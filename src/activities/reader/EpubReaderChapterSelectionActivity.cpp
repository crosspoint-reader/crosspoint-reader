...
void EpubReaderChapterSelectionActivity::renderScreen() {
  ...
  const std::string title =
      renderer.truncatedText(UI_12_FONT_ID, epub->getTitle().c_str(), pageWidth - 40, CrossPointFont::BOLD);
  renderer.drawCenteredText(UI_12_FONT_ID, 15, title.c_str(), true, CrossPointFont::BOLD);

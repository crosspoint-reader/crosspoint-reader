...
void CrossPointWebServerActivity::render() const {
  ...
  if (state == WebServerActivityState::SERVER_RUNNING) {
    ...
    renderer.drawCenteredText(UI_12_FONT_ID, pageHeight / 2 - 20, "Starting Hotspot...", true, CrossPointFont::BOLD);
    renderer.displayBuffer();
  }
}
...
void CrossPointWebServerActivity::renderServerRunning() const {
  ...
  if (isApMode) {
    ...
    renderer.drawCenteredText(UI_10_FONT_ID, startY, "Hotspot Mode", true, CrossPointFont::BOLD);
    ...
    renderer.drawCenteredText(UI_10_FONT_ID, startY + LINE_SPACING * 2, webInfo.c_str(), true, CrossPointFont::BOLD);

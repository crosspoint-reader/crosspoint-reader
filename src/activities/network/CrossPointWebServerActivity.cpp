...
void CrossPointWebServerActivity::render() const {
  ...
  if (state == WebServerActivityState::SERVER_RUNNING) {
    ...
    renderer.drawCenteredText(UI_12_FONT_ID, pageHeight / 2 - 20, T("Starting Hotspot..."), true, EpdFontFamily::BOLD);
    renderer.displayBuffer();
  }
}
...
void CrossPointWebServerActivity::renderServerRunning() const {
  ...
  if (isApMode) {
    ...
    renderer.drawCenteredText(UI_10_FONT_ID, startY, T("Hotspot Mode"), true, EpdFontFamily::BOLD);
    ...
    renderer.drawCenteredText(SMALL_FONT_ID, startY + LINE_SPACING * 2, T("Connect your device to this WiFi network"));

    renderer.drawCenteredText(SMALL_FONT_ID, startY + LINE_SPACING * 3,
                              T("or scan QR code with your phone to connect to Wifi."));
    ...
    renderer.drawCenteredText(SMALL_FONT_ID, startY + LINE_SPACING * 5, T("Open this URL in your browser"));

    // Show QR code for URL
    renderer.drawCenteredText(SMALL_FONT_ID, startY + LINE_SPACING * 6, T("or scan QR code with your phone:"));
    ...
    renderer.drawCenteredText(SMALL_FONT_ID, startY + LINE_SPACING * 4, T("Open this URL in your browser"));

    // Show QR code for URL
    drawQRCode(renderer, (480 - 6 * 33) / 2, startY + LINE_SPACING * 6, webInfo);
    renderer.drawCenteredText(SMALL_FONT_ID, startY + LINE_SPACING * 5, T("or scan QR code with your phone:"));
  }

...
void SettingsActivity::onEnter() {
  ...
  systemSettings.push_back(SettingInfo::Action(StrId::STR_WALLABAG, SettingAction::Wallabag));
  ...
  if (setting.type == SettingType::TOGGLE && setting.valuePtr != nullptr) {
    ...
    switch (setting.action) {
      ...
      case SettingAction::OPDSBrowser:
        ...
        break;
      case SettingAction::Wallabag:
        enterSubActivity(new WallabagSettingsActivity(renderer, mappedInput, onComplete));
        break;

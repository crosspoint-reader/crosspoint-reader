...
class Activity {
 ...
 public:
  ...
  // True for the reading surfaces night mode inverts (EPUB/TXT). Resolved per
  // render by ActivityManager, so menus, overlays, and every other screen keep
  // normal polarity without managing the display flag themselves.

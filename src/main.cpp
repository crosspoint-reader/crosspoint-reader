...
void setup() {
  ...
  switch (wakeupReason) {
    case HalGPIO::WakeupReason::PowerButton:
      ...
      gpio.verifyPowerButtonWakeup(SETTINGS.getPowerButtonWakeDuration(), SETTINGS.isShortWakeAllowed());
      break;
...
void loop() {
  ...
  if (millis() >= allowSleepAt && gpio.isPressed(HalGPIO::BTN_POWER) &&
      gpio.getPowerButtonHeldTime() > SETTINGS.getPowerButtonSleepDuration()) {

...
class CrossPointSettings {
 ...
 public:
  ...
  // Font family options
  enum FONT_FAMILY { BOOKERLY = 0, NOTOSANS = 1, OPENDYSLEXIC = 2, ANTONIO = 3, FONT_FAMILY_COUNT };
  // Font size options
  ...
  // UI Theme
  enum UI_THEME { CLASSIC = 0, LYRA = 1, LYRA_3_COVERS = 2, PULSR = 3, DARK_PULSR = 4, UI_THEME_COUNT };

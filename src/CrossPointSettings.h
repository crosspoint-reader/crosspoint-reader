...
class CrossPointSettings {
 ...
 public:
  ...
  // Font size options (extra small at the end for backward compatibility)
  enum FONT_SIZE { SMALL = 0, MEDIUM = 1, LARGE = 2, EXTRA_LARGE = 3, EXTRA_SMALL = 4, FONT_SIZE_COUNT };

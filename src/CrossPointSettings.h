...
class CrossPointSettings {
 ...
 public:
  ...
  // Power+Down button combo actions
  enum POWER_DOWN_COMBO { SCREENSHOT = 0, FORCE_REFRESH = 1, POWER_DOWN_COMBO_COUNT };
  ...
  // Power+Down button combo behaviour (screenshot or force refresh)
  uint8_t powerDownCombo = SCREENSHOT;

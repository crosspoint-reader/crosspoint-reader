    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_SHORT_PWR_BTN, &CrossPointSettings::shortPwrBtn,
                          {StrId::STR_IGNORE, StrId::STR_SLEEP, StrId::STR_PAGE_TURN, StrId::STR_FORCE_REFRESH,
                           StrId::STR_FOOTNOTES, StrId::STR_QUICK_LOCK},
                          "shortPwrBtn", StrId::STR_CAT_CONTROLS),
        SettingInfo::Enum(StrId::STR_POWER_BUTTON_CHORD, &CrossPointSettings::powerChordAction,
                          {StrId::STR_SCREENSHOT, StrId::STR_QUICK_LOCK, StrId::STR_NEXT_PAGE, StrId::STR_PREV_PAGE,
                           StrId::STR_DISABLED},
        ...
        SettingInfo::Value(StrId::STR_QUICK_LOCK_SLEEP_TIMEOUT, &CrossPointSettings::quickLockSleepTimeoutMinutes,

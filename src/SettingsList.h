...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      SettingInfo::Enum(StrId::STR_STABLE_PAGES, &CrossPointSettings::statusBarStablePages,
                        {StrId::STR_HIDE, StrId::STR_STATUS_BAR_STABLE_IF_SET, StrId::STR_STATUS_BAR_STABLE_ELSE_PCT},
                        "statusBarStablePages", StrId::STR_CUSTOMISE_STATUS_BAR),

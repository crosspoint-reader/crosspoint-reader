  ...
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(
            ...
            {StrId::STR_PAGES_OFF, StrId::STR_PAGES_1, StrId::STR_PAGES_5, StrId::STR_PAGES_10, StrId::STR_PAGES_15,
             StrId::STR_PAGES_30, StrId::STR_PAGES_50, StrId::STR_PAGES_100}, "refreshFrequency", StrId::STR_CAT_DISPLAY),

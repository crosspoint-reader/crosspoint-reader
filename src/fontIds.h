...
#define NOTOSERIF_5_FONT_ID (2027203861)
#define NOTOSERIF_6_FONT_ID (-1433983666)
#define NOTOSERIF_7_FONT_ID (-637638316)
...
#define NOTOSANS_5_FONT_ID (1124820721)
#define NOTOSANS_6_FONT_ID (998829314)
#define NOTOSANS_7_FONT_ID (-986282639)
#define NOTOSANS_8_FONT_ID (-1949787707)
...
static_assert(NOTOSERIF_7_FONT_ID != 0, "Font ID collision with sentinel");
...
static_assert(NOTOSANS_5_FONT_ID != 0, "Font ID collision with sentinel");
static_assert(NOTOSANS_6_FONT_ID != 0, "Font ID collision with sentinel");
static_assert(NOTOSANS_7_FONT_ID != 0, "Font ID collision with sentinel");
static_assert(NOTOSANS_8_FONT_ID != 0, "Font ID collision with sentinel");

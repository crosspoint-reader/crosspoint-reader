...
// Setting data types — used by both SettingsList and the web settings API.
// Deliberately kept free of Activity/UI dependencies so it can be used in
// native unit tests.

...
`uiScale` 1.2. Bezel insets 9/7/3/7.

When a committed env exists it is expected to set `-DFREEINK_DEVICE_X4PRO=1`,
`-DBOARD_HAS_PSRAM`, and `-DUSE_BLOCK_DEVICE_INTERFACE=1`. 8 MB PSRAM on
silicon.

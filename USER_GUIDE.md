...
- **Long-press Behavior**: Choose what happens when a page-turn button is held:

  - "Off" - Use only the configured short-press page-turn action.
  - "Chapter Skip" - Long-pressing skips to the next or previous chapter.
  - "Orientation change" - Long-pressing rotates the reading view.
  - "Previous Page" - Long-pressing either side button turns back one page while its short press keeps the configured
    direction.

...
* **KOReader Sync shortcut (optional):** Long-press **Confirm** (~1 second) to launch KOReader Sync directly, when **Long-press Menu** is set to "KOSync" in **[Controls Settings](#363-controls)**. Short-press still opens the Chapter Menu as normal.

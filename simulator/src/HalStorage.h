...
public:
  ...
  // Zero means the preceding operation reached a normal end condition.
  // Non-zero lets directory scans distinguish EOF from a host filesystem
  // failure, matching the firmware HAL contract.
